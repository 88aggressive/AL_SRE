...
import sys
sys.path.append("AL_SRE/support")
import utils
    ...
    def wrapper(function):
        def _wrapper(self, input):
            ...
            with torch.no_grad():
                ...
                #
                input = utils.to_device(self, input)  # [1,56,1751]
                ...
                # print("last_embed:",last_embedding)
...
class FTdnnBlock(torch.nn.Module):
    ...
    def get_semi_orth_weight(conv1dlayer):
        ...
        # based off ConstrainOrthonormalInternal in model-utils.cc in Kaldi src/nnet3
...
## ReluBatchNormLayer
class ReluBatchNormTdnnLayer(torch.nn.Module):
