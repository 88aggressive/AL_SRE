...
from .components import SEBlock_2D
...
class ResNet(nn.Module):
    ...
    def __init__(self, head_inplanes, block="BasicBlock", layers=[3, 4, 6, 3], planes=[32, 64, 128, 256], convXd=2, 
        ...
        if replace_stride_with_dilation is None:
            ...
            replace_stride_with_dilation = [False, False, False]  # 不使用膨胀卷积
        ...
        self.downsample_multiple *= 8  # 保持特征图的大小匹配。
        ...
        # kaiming_normal_ 高斯分布，解决梯度消失和爆炸
